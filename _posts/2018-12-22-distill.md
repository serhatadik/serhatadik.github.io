...
def add_rad_patt(tirem_preds, map, map_res, tx_antenna_raster_idx, tx_antenna_height, rx_antenna_height,
    ...
    tx_elevation = map[tx_antenna_raster_idx[0], tx_antenna_raster_idx[1]]
    ...
    for i in range(dim1):
        for j in range(dim2):
            rx_total_height = map[i, j] + rx_antenna_height
            ...
            elevs[i, j] = el_angle  # 90 - np.degrees(math.atan(slope))
