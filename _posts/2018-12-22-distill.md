...
.responsive-iframe {
    position: relative;
    overflow: hidden;
    height: 100vh; /* Sets a viewport relative height */
    width: 50%; /* Each iframe should take half of the width */
}
...
<div class="figure-container2">
  <div class="responsive-iframe">
    <iframe src="{{ '/assets/plotly/demo_TIREM_nopattern.html' | relative_url }}" frameborder="0" scrolling="yes" style="border: 0px solid rgba(150, 150, 150, 0.5);"></iframe>
  </div>
  <div class="responsive-iframe">
    <iframe src="{{ '/assets/plotly/demo_TIREMwAntenna.html' | relative_url }}" frameborder="0" scrolling="yes" style="border: 0px solid rgba(150, 150, 150, 0.5);"></iframe>
  </div>
</div>
