...
.figure-container {
    display: flex;
    justify-content: space-around; /* Adjusts spacing between iframes */
    flex-wrap: wrap; /* Allows items to wrap as needed */
}

/* Responsive iframes with adjusted width for side-by-side view */
.figure-container iframe {
    flex: 0 1 48%; /* Allows the iframe to grow and shrink but with a base of 48% width */
    height: auto; /* Adjust height as needed, or set to a specific value for uniformity */
...
.responsive-iframe {
    position: relative;
    overflow: hidden;
    padding-bottom: 26%; /* Adjust based on the aspect ratio of the content */
}
...
@media only screen and (max-width: 600px) {
    ...
    .figure-container iframe {
        flex: 0 0 100%; /* Makes iframe take full width on small screens */
    }

    .responsive-iframe {
        padding-bottom: 100%; /* Adjust for aspect ratio on small screens */
