...
.figure-container2 {
    display: flex;
    justify-content: space-between; /* Ensures iframes are spaced evenly */
    align-items: stretch; /* Stretches items to fill the container vertically */
...
/* Responsive iframes */
.figure-container2 .responsive-iframe {
    flex: 1; /* Allows the iframe to grow and fill the space evenly */
    min-width: 50vw; /* Each iframe will take at least half of the viewport width */
...
@media only screen and (max-width: 600px) {
    ...
    .figure-container2 .responsive-iframe {
        min-width: 100vw; /* Each iframe should take the full width of the viewport on small screens */
...
<div class="figure-container2">
  <div class="responsive-iframe">
    <iframe src="{{ '/assets/plotly/demo_TIREM_nopattern.html' | relative_url }}" frameborder="0" scrolling="yes" style="border: 0;"></iframe>
  </div>
  <div class="responsive-iframe">
    <iframe src="{{ '/assets/plotly/demo_TIREMwAntenna.html' | relative_url }}" frameborder="0" scrolling="yes" style="border: 0;"></iframe>
  </div>
</div>
