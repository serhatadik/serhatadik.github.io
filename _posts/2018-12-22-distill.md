...
.figure-container2 .responsive-iframe {
    flex: 0 0 50%; /* The iframe will not grow or shrink and will maintain a base size of 50% */
...
@media only screen and (max-width: 600px) {
    ...
    .figure-container2 .responsive-iframe {
        width: 100vw; /* Each iframe should take the full width of the viewport on small screens */
        height: auto; /* Adjust the height automatically */
        flex: 0 0 auto; /* Adjust flex setting for small screens */
    }
}
</style>
